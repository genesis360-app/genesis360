...
| [[wiki/development/testing]] | **625 unit tests** Vitest (`fileParallelism:false`) + **129 E2E** Playwright (16 specs, roles owner/cajero/supervisor/rrhh) · suite e2e reparada v1.51.1 + gobernanza caja · pipeline QA con agentes · `tests/specs/` | ✅ |
