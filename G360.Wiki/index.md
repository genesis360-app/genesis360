...
| [[wiki/features/ventas-pos]] | Carrito · 3 modos · CC parcial · cuotas · ticket por sucursal · envío con autocompletado + Haversine · selector courier propio/tercero · multi-sucursal estricto · **reservas**: seña obligatoria/mínima + vencimiento con liberación automática + cancelación con penalidad/crédito (mig 160) · **presupuestos** correlativo `PRES-NNNN` (mig 159) · costo/margen oculto a CAJERO/DEPOSITO | ✅ |
...
| [[wiki/database/migraciones]] | 001–158 en PROD · 159–160 en DEV (reservas/presupuestos) · descripción completa | ✅ |
