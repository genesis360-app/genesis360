...
| [[wiki/features/rrhh]] | 5 fases base + **RRHH 2.0: RH1+RH2+RH3+RH4+RH5+RH6 ✅ PROD (v1.46.0-v1.47.0, mig 195-200)** — RH1 empleados 2.0 (obligatorios, motivo egreso+reactivar, tipo contrato configurable, datos bancarios), RH2 aportes AR configurables por empleado + SAC mejor sueldo semestre, RH3 nómina contable (pagar→gasto en Gastos pendiente + cargas sociales + recibo PDF + comprobante firmado + doble validación), RH4 frecuencia de liquidación (prorratea básico) + anticipos con descuento auto, RH5 vacaciones 2.0 (días LCT por antigüedad + aviso/solapamiento + remanente auto), RH6 asistencia 2.0 (fichado/horario/licencias/horas extra/feriados regla pago). Libs rrhhNomina/rrhhAsistencia/rrhhLiquidacion/rrhhVacaciones + reciboSueldoPDF. **Faltan RH7/RH8** + (RH6) QR público + auto-descuento tardanza | ✅ |
