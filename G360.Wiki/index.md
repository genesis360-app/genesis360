...
| [[wiki/features/rrhh]] | 5 fases base: empleados, nómina, vacaciones, asistencia, supervisor · **RRHH 2.0: RH1+RH2+RH3+RH6 ✅ PROD (v1.46.0, mig 195-198)** — RH1 empleados 2.0 (obligatorios, motivo de egreso+reactivar, tipo de contrato configurable, datos bancarios), RH2 aportes AR configurables por empleado + SAC mejor sueldo semestre, RH3 nómina contable (pagar→gasto en Gastos pendiente + cargas sociales + recibo PDF + comprobante firmado + doble validación), RH6 asistencia 2.0 (fichado/horario/licencias/horas extra/feriados regla pago). Libs rrhhNomina/rrhhAsistencia + reciboSueldoPDF. **Faltan RH4/RH5/RH7/RH8** + (RH6) QR público + auto-descuento tardanza | ✅ |
