...
| [[wiki/features/inventario-stock]] | LPNs, FIFO/FEFO, stock sucursal, bulk edit · **Conteos 2.0 F1-F4 completo** (scope marca/wall-to-wall · modos+ciego · gate+autorizaciones+delta · scan-to-count · ABC+cíclico+reportes+trazabilidad) · rebaje masivo fix · shortcuts ESC/ENTER · filtros pill · modales inline | ✅ |
