...
- ⏳ **Residual Tanda A** (ver `project_pendientes.md`; alto costo de fixtures frágiles de plata/stock o externo, ya cubierto en impersonación/unit): §29 fiscal AFIP (externo), morosidad CC (fixture venta vencida frágil; guard 234 ya 8/8), pagar nómina (RRHH multi-paso), over-receipt (OC+recepción), clave SIN configurar (requiere tenant sin clave), aprobación de ajuste con 2 actores.
