...
| | DEV | PROD |
|---|---|---|
| APP_VERSION | `v1.43.0` | `v1.43.0` |
| Migrations | 001–**192** ✅ | 001–**192** ✅ |
| Branch | `dev` (alineado con `main`) | `main` (release v1.43.0) |
| Vercel | preview auto desde `dev` | PROD deploy v1.43.0 |

**Migrations DEV pendientes de aplicar en PROD:** ninguna (192 ya en PROD).
