...
| | DEV | PROD |
|---|---|---|
| APP_VERSION | `v1.60.1` ✅ (suite 734) | `v1.60.1` ✅ |
| Migrations | 001–**210** ✅ | 001–**210** ✅ |
| Branch | `dev` (= `main` salvo doc de cierre) | `main` (release v1.60.1, PR #198, `39705d38`) |
| Vercel | preview auto desde `dev` | PROD deploy v1.60.1 (auto desde `main`) |
...
**Migrations DEV pendientes de aplicar en PROD:** ninguna (001–210 ya en PROD; v1.60.1 fue solo frontend). **EF `emitir-factura` v8 ✅ en PROD.** Cadena reciente:
