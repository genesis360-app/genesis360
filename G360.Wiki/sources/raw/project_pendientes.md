...
| | DEV | PROD |
|---|---|---|
| APP_VERSION | `v1.29.0` | `v1.29.0` |
| Migrations | 001–**180** ✅ | 001–**180** ✅ |
| Branch | `dev` (alineado con `main`) | `main` (release v1.29.0) |
| Vercel | preview auto desde `dev` | PROD deploy v1.29.0 |

**Migrations DEV pendientes de aplicar en PROD:** ninguna (180 ya en PROD).
