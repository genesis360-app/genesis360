...
| | DEV | PROD |
|---|---|---|
| APP_VERSION | `v1.45.0` | `v1.45.0` |
| Migrations | 001–**194** ✅ | 001–**194** ✅ |
| Branch | `dev` (alineado con `main`) | `main` (release v1.45.0) |
| Vercel | preview auto desde `dev` | PROD deploy v1.45.0 |

**Migrations DEV pendientes de aplicar en PROD:** ninguna (194 ya en PROD).
