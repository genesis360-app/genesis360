...
> - **▶ Módulo en curso: GASTOS** (`cobertura/03` §Gastos): comprobante obligatorio (4 reglas `gastos_comp_*`), período contable cerrado bloquea, eliminar gasto→reversión en caja, pago de OC con doble firma/clave. Luego: Clientes/CC residual (revertir condonación, vencimiento CC, crédito a favor positivo).
