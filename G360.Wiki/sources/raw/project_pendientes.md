...
| | DEV | PROD |
|---|---|---|
| APP_VERSION | `v1.44.0` | `v1.44.0` |
| Migrations | 001–**193** ✅ | 001–**193** ✅ |
| Branch | `dev` (alineado con `main`) | `main` (release v1.44.0) |
| Vercel | preview auto desde `dev` | PROD deploy v1.44.0 |
