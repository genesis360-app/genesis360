...
| | DEV | PROD |
|---|---|---|
| APP_VERSION | `v1.60.0` ✅ (suite 734) | `v1.60.0` ✅ |
| Migrations | 001–**210** ✅ | 001–**210** ✅ |
| Branch | `dev` (= `main` salvo doc de cierre) | `main` (release v1.60.0, PR #197, `427a03c4`) |
| Vercel | preview auto desde `dev` | PROD deploy v1.60.0 (auto desde `main`) |
