...
Último release en PROD: **v1.8.22** ✅ · DEV: **v1.8.24** (fixes post-deploy)

**Versionado:** Semántico — Major=breaking/hito grande · Minor=feature · Patch=bugfix.

---

## Estado actual DEV v1.8.24 / PROD v1.8.22 (cierre sesión 2026-05-15)

- APP_VERSION DEV: `v1.8.24` en `src/config/brand.ts` ✅
