...
| | DEV | PROD |
|---|---|---|
| APP_VERSION | `v1.34.0` | `v1.34.0` |
| Migrations | 001–**185** ✅ | 001–**185** ✅ |
| Branch | `dev` (alineado con `main`) | `main` (release v1.34.0) |
