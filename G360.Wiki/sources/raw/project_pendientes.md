...
## Estado actual DEV / PROD — cierre sesión 2026-06-06

| | DEV | PROD |
|---|---|---|
| APP_VERSION | `v1.40.0` | `v1.40.0` |
| Migrations | 001–**189** ✅ | 001–**189** ✅ |
| Branch | `dev` (alineado con `main`) | `main` (release v1.40.0) |
| Vercel | preview auto desde `dev` | PROD deploy v1.40.0 |

**Migrations DEV pendientes de aplicar en PROD:** ninguna (189 ya en PROD).
