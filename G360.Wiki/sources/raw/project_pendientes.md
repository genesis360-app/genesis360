...
| | DEV | PROD |
|---|---|---|
| APP_VERSION | `v1.41.0` | `v1.41.0` |
| Migrations | 001–**190** ✅ | 001–**190** ✅ |
| Branch | `dev` (alineado con `main`) | `main` (release v1.41.0) |
| Vercel | preview auto desde `dev` | PROD deploy v1.41.0 |

**Migrations DEV pendientes de aplicar en PROD:** ninguna (190 ya en PROD).
