...
| | DEV | PROD |
|---|---|---|
| APP_VERSION | `v1.42.0` | `v1.42.0` |
| Migrations | 001–**191** ✅ | 001–**191** ✅ |
| Branch | `dev` (alineado con `main`) | `main` (release v1.42.0) |
| Vercel | preview auto desde `dev` | PROD deploy v1.42.0 |

**Migrations DEV pendientes de aplicar en PROD:** ninguna (191 ya en PROD).
