...
Último release en PROD: **v1.8.27** ✅ · DEV: **v1.8.29** (atributos producto + UdM + inactivos + variantes)

**Versionado:** Semántico — Major=breaking/hito grande · Minor=feature · Patch=bugfix.

---

## Estado actual DEV v1.8.29 / PROD v1.8.27 (cierre sesión 2026-05-17)

- APP_VERSION DEV: `v1.8.27` en `src/config/brand.ts` (bump pendiente a v1.8.29)
- APP_VERSION PROD: `v1.8.27` ✅ (PR #112 mergeado)
- Migrations DEV: 001–119 ✅ (118: campos producto variantes + 119: unidades_medida)
- Migrations PROD: 001–110 ✅ (113–119 pendientes de aplicar en PROD)
