...
> **Barrido UAT al día:** Ventas Tanda A+B ✅ · Caja/Bóveda ✅ (64-67) · Gastos ✅ (68 + guards server-side) · Clientes/CC ✅ (núcleo: 46/49/39/69/40/28; residual DIFERIDO — fixtures que rebajan stock = riesgo REGLA #0) · Productos núcleo fiscal ✅ (43+70) · Inventario/Conteos ✅ (36/47/51/52/71 + traslados 30 + recepción 29/35). **▶ Próximo barrido:** Inventario residual (over-receipt CON, conteo gate/reconteo, wall-to-wall cross-página, kits) · Compras/OC/Envíos (cobertura/04) · RRHH/Config/Suscripción (cobertura/05). **DIFERIDOS de Clientes:** vencimiento CC (one-liner+aging unit), crédito-positivo (mismo insert que spec 59), incobrable SIN clave (falta harness DUEÑO sin-clave).
>
