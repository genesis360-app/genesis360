...
| | DEV | PROD |
|---|---|---|
| APP_VERSION | `v1.56.0` 🚧 | `v1.54.0` ✅ |
| Migrations | 001–**207** ✅ | 001–**206** ✅ |
| Branch | `dev` (adelantado: v1.55.0 + v1.56.0) | `main` (release v1.54.0) |
