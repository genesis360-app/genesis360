...
> ### 🟢 ARRANCÁ ACÁ (2026-06-30 · 🔐 Hardening billing + least-privilege anon v1.99.0 · EN PROD)
> **Estado:** **PROD = DEV = v1.99.0 (migs 001-248)** ✅ — Vercel desplegado + EF `mp-verificar-suscripcion` en DEV+PROD. typecheck+build+**819 unit** verdes.
>
