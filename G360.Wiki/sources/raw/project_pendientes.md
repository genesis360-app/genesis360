...
| | DEV | PROD |
|---|---|---|
| APP_VERSION | `v1.45.0` | `v1.44.0` |
| Migrations | 001–**194** ✅ | 001–**193** ✅ |
| Branch | `dev` (EN7, adelante de main) | `main` (release v1.44.0) |
| Vercel | preview auto desde `dev` | PROD deploy v1.44.0 |

**Migrations DEV pendientes de aplicar en PROD:** **194** (Envíos EN7) — al deployar v1.45.0.
