...
| **4 — Configurador de precios (Landing + Suscripción)** ✅ **HECHA (2026-07-02, v1.103.0)** | Suscripción ✅ (add-ons fijos en vivo, F3). Landing ✅ (`PricingConfigurator`: plan base Básico/Pro + selectores de add-ons fijos → total mensual en vivo; reusa `addons.ts`). Frontend-only. | Bajo | Estimador público (marketing); no cobra. |
