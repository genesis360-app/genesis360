...
| **4 — Configurador de precios (Landing + Suscripción)** | Suscripción ✅ (configurador de add-ons fijos en vivo, F3). Falta el de **Landing** (plan base + selectores). | Bajo | Cosmético/comercial, después de que el backend cobre. |
