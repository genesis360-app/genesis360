...
**🟡 Migraciones 427-429 — ✅ EN DEV, sin PROD** (2026-09-15, cont. 71, después del deploy). Las 3 decisiones de GO
que seguían tras el deploy a PROD, construidas el mismo día: DEV pasa a `v1.227.0`, migs 001-429; **PROD sigue en
`v1.226.0`, 001-426**. Policies DEV: `public` **234** (PROD 231: +2 por los vínculos ML/TN de la 427, +1
`ayuda_recursos` de la 429), `storage` 40, `cron` 2 (sin cambios). tsc + build + eslint verdes, **1848 unit tests**
(112 archivos), `schema_full.sql` regenerado (170 tablas, 239 funciones, **234 policies**). e2e nuevos **153**
