...
- **EN7 — Envío propio + reportes (G2 + H1-H3) ✅ DEV (v1.45.0, mig 194):** recurso (vehículo) + KM + **combustible auto-gasto** · reportes (pendientes, cumplimiento courier, pagos/mes, margen logístico, zona/CP, productividad) · alertas configurables · export Excel/PDF/CSV + etiquetas A4 con QR + hoja de ruta PDF.
