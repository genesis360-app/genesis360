...
- **Dark/Light mode**
- **Botón ayuda** (ícono `?`): abre el `AyudaModal` (panel lateral) — 🆕 2026-09-15 (mig 426): "Reportar un problema" crea un ticket real (no un mail suelto) + link "Ver mis consultas" a `/ayuda/consultas` · 🆕 2026-09-15 (mig 429): hasta 3 videos de "Cursos y recursos" (primero los del módulo actual) + link "Ver todos" a `/ayuda/recursos`
...
consultas" ya funcionan.** 🆕 **2026-09-15 (mig 429, ✅ EN PROD desde el segundo deploy del día): "Cursos y recursos"
ya funciona** (ver más abajo) — las 3 tarjetas que quedan (FAQ, chat en vivo, guías interactivas) siguen con badge
"Próximamente".
...
#### "Cursos y recursos" (mig 429, 2026-09-15, ✅ EN DEV Y EN PROD)
...
✅ `npm run ai:knowledge` corrido y la EF `ai-assistant` redeployada en DEV y PROD (el segundo deploy del
2026-09-15) — el Asistente IA ya conoce esta sección. Si se vuelve a tocar este archivo, repetir el paso.
