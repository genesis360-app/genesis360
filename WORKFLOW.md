...
| v1.6.1 ✅ | Sentry integrado (@sentry/react — errores, performance, replays) · Security hardening: 80→7 warnings Supabase Advisor (REVOKE FROM PUBLIC + SET search_path + buckets authenticated) · OC: cantidad respeta unidad_medida (esDecimal) + descargar PDF/CSV · npm audit: 21→7 vulnerabilidades · Migrations 086+086b PROD ✅ · PR #102 | 2026-05 |
| v1.7.0 ✅ | API pull: EF data-api (--no-verify-jwt) + tabla api_keys (migration 087) + tab "API" en ConfigPage (CRUD keys + docs inline) · Exportar JSON/CSV en ProductosPage/ClientesPage/ProveedoresPage · Migration 087 PROD ✅ | 2026-05 |
| v1.8.0 ✅ | Email al cliente al emitir CAE (send-email tipo factura_emitida) · NC electrónicas: EF emitir-factura acepta NC-A/B/C + devolucion_id, guarda en devoluciones (migration 088) · VentasPage botón Emitir NC en sección devoluciones · GastosPage OC: medios de pago mixtos + fix CC + OC pagadas al fondo con expand + ProveedoresPage bloquea confirmar con pago_parcial · Migrations 087+088 PROD ✅ | 2026-05 |
