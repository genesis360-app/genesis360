...
| v0.83.0 | Tab Conteo en InventarioPage: por ubicación o por producto, tabla diferencias esperado/contado, guardar borrador o finalizar + ajustes automáticos (ajuste_ingreso/ajuste_rebaje), historial expandible · Tab Estructura en LpnAccionesModal: asignar/cambiar estructura del LPN (selector con dimensiones) · Migration 050: recepciones + recepcion_items + OC estados recibida_parcial/recibida + inventario_conteos + inventario_conteo_items + inventario_lineas.estructura_id | 2026-04 |
