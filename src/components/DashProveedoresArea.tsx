    ...
    <div className="space-y-5">
        ...
        <div className="relative" ref={filterRef}>
          ...
          {filterOpen && (
            <div className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl z-50 p-5">
              ...
              <a href="/proveedores" className="block mt-3 text-center text-xs font-medium text-accent-text hover:underline">Ir a Proveedores →</a>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-surface border border-border-ds rounded-xl p-5 shadow-sm">
          <div className="mb-3"><div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-violet-100 dark:bg-violet-900/30 text-accent-text"><Flame size={20} /></div></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-surface border border-border-ds rounded-xl p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-4"><DollarSign size={15} className="text-accent-text" /><h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Concentración de Gasto</h3><span className="ml-auto text-xs text-muted">Top 5 proveedores</span></div>
        ...
        {/* Aging OC */}
        <div className="bg-surface border border-border-ds rounded-xl p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-4"><AlertTriangle size={15} className="text-accent-text" /><h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Muro de Vencimientos</h3><span className="ml-auto text-xs text-muted">OC pendientes</span></div>
      ...
      {/* Evolución gastos */}
      <div className="bg-surface border border-border-ds rounded-xl p-5 shadow-sm">
        <div className="flex items-center gap-2 mb-4"><BarChart2 size={15} className="text-accent-text" /><h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Evolución de Gastos</h3><span className="ml-auto text-xs text-muted">Últimos 6 meses</span></div>
      ...
      {insights.length > 0 && (
        <div>
          <div className="flex items-center gap-2 mb-3"><Zap size={15} className="text-accent-text" /><h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Tu Auditor Financiero</h3><span className="text-xs text-muted bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded-full">{insights.length}</span></div>
