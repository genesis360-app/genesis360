              ...
              return (
                <div key={cat}>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="font-medium text-gray-800 dark:text-gray-100 flex-shrink-0 ml-2">{formatMoneda(total)}</span>
                  </div>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 dark:bg-gray-700 border-b border-gray-100 dark:border-gray-600">
                <tr>
                  ...
                  <th className="text-left px-4 py-3 font-semibold text-gray-600 dark:text-gray-300">Medio de pago</th>
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full border border-gray-200 dark:border-gray-600 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-accent resize-none"
                />
              </div>
            </div>
