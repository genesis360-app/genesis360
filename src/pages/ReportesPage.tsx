...
const REPORTES: ReporteConfig[] = [
  { id: 'stock',      titulo: 'Stock actual',          descripcion: 'Listado completo de productos con cantidades por línea',  icon: Package,         color: 'bg-blue-50 text-blue-600' },
  ...
  { id: 'ventas',     titulo: 'Ventas',                 descripcion: 'Ventas por período, por producto y por cliente',          icon: ShoppingCart,    color: 'bg-green-50 text-green-600' },
  { id: 'criticos',   titulo: 'Productos críticos',     descripcion: 'Productos con stock igual o por debajo del mínimo',       icon: AlertTriangle,   color: 'bg-red-50 text-red-500' },
  ...
  { id: 'valorizado', titulo: 'Inventario valorizado',  descripcion: 'Stock actual multiplicado por precio de costo',           icon: DollarSign,      color: 'bg-yellow-50 text-yellow-600' },
]
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between flex-wrap gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-semibold text-gray-800">{reporteSeleccionado.titulo}</h2>
                <p className="text-xs text-gray-400">{datos.length} registros</p>
              </div>
            </div>
          ...
          {reporteActivo === 'valorizado' && (
            <div className="grid grid-cols-2 divide-x divide-gray-100 border-b border-gray-100">
              ...
              <div className="px-5 py-3 text-center">
                ...
                <p className="text-xl font-bold text-green-600">{formatMoneda(totalesReporte.valorizado.venta)}</p>
              </div>
            </div>
          )}
          {reporteActivo === 'ventas' && (
            <div className="grid grid-cols-2 divide-x divide-gray-100 border-b border-gray-100">
              ...
              <div className="px-5 py-3 text-center">
                ...
                <p className="text-xl font-bold text-green-600">{formatMoneda(totalesReporte.ventas.total)}</p>
              </div>
            </div>
          )}
                ...
                <thead className="sticky top-0 bg-gray-50">
                  <tr className="border-b border-gray-100">
                    {Object.keys(datos[0]).map(col => (
                      <th key={col} className="text-left px-3 py-2.5 font-semibold text-gray-600 whitespace-nowrap">{col}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
