...
| **04 Compras/OC/Envíos** | ✅ CERRADO | e2e 31-35/38/77-80/**85** · RPCs `registrar_pago_oc`/`marcar_envios_pagados` (mig 237/238, impersonación DB) · unit (comprasPago/Cheques/Costos, enviosTarifas/CourierPago/Recurso) · **L22 precio_costo code-verified** · **spec 85 (2026-07-09): bug real arreglado — envío propio creado a mano (modal manual) nacía con `courier=null`, ver `cobertura/04_compras_oc_envios.md`** · EN6 courier B2B (⛔ terceros) |
