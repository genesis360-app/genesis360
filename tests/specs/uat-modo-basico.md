...
| 66.17 | El export de productos emite **todas las columnas de la plantilla del importador**, así se puede editar en Excel y volver a subir. Los booleanos salen como SI/NO | revisión de `exportarProductos` | ✅ |
