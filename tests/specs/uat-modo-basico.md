...
| 70.5 | 🛑 POS: un producto en USD **sin** cotización NO se vende al `precio_venta` en pesos guardado (congelado a la tasa del día en que se editó) — antes caía ahí en silencio. Ahora frena con aviso (D5) | revisión de `VentasPage.agregarProducto`. 🟡 sin test (hace falta vaciar `cotizaciones_bna`) | 🟡 |
