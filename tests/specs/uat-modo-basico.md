...
| 66.16 | ✅ **D-2 mitigado en la ficha** — cargar costo $100 y precio $1.200 devolvía un `numeric field overflow` crudo de Postgres. Ahora avisa con el mismo mensaje que el importador, antes de intentar guardar. ⚠️ **El tope de 999,99 % sigue existiendo**: ampliarlo es una decisión de GO todavía abierta | validación en `handleSubmit` con `margenEntraEnLaBase` | ✅ |
